...
/*!
 * Class that represents a capital letter I trajectory in the XY plane
 */
class I : public Trajectory
{
public:
    I(double cx, double cy, double length, double width, double alt,
    ...
    snapstack_msgs2::msg::Goal createIGoal(double x, double y, double v, double accel, double heading) const;
...
private:
    ...
    double t_traj_;
    rclcpp::Logger logger_ = rclcpp::get_logger("i_logger");
};
